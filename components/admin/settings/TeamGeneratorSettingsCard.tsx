...
export default function TeamGeneratorSettingsCard({
  ...
  return (
    <div className="rounded-[24px] border border-black/10 bg-white p-5 shadow-sm">
      <div className="mb-5">
        <div className="text-sm font-semibold text-slate-500">Einstellungen</div>
        <h2 className="text-2xl font-extrabold tracking-tight text-slate-950">
          Teamgenerator
        </h2>
        <p className="mt-2 text-sm text-slate-600">
          Lege fest, welche Faktoren beim automatischen Aufteilen der Teams
        ...
        <details className="mt-4 rounded-2xl border border-black/10 bg-white px-4 py-3">
          ...
          <div className="mt-4 space-y-3 text-sm leading-6 text-slate-600">
            ...
            <p>
              ...
              Kategorien sind Gruppen wie zum Beispiel <strong>AH</strong> oder{" "}
              <strong>Ü32</strong>. Wenn Kategorien aktiv sind, verteilt der
              Generator diese Gruppen möglichst gleichmäßig auf beide Teams.
            </p>
            ...
            <p>
              ...
              Wenn Stärke aktiv ist, schaut STRIKR zusätzlich auf die hinterlegte
              Spielstärke der Spieler, damit nicht versehentlich alle stärkeren
              Spieler in einem Team landen.
            </p>
            ...
            <p>
              ...
              Dann werden die Teams ohne Kategorie- und Stärkebalance verteilt.
              Die Aufteilung ist dann deutlich zufälliger.
            </p>
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
              ...
              <p className="mt-3">
                ...
                dass beide Teams eine ähnliche Anzahl an AH- und Ü32-Spielern
                haben.
              </p>
              <p className="mt-2">
                Wenn zusätzlich Stärke aktiv ist, achtet STRIKR außerdem darauf,
                dass die geschätzte Gesamtstärke beider Teams ähnlich bleibt.
              </p>
