...
function positionLabel(player: PlayerRow, settings: ClubSettingsRow | null) {
  if (player.preferred_position === "attack") return settings?.attack_label || "Mittelfeld/Vorne";
