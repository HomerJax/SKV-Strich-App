...
export default function BigUpdateLaunchModal() {
  ...
  return (
    <div className="fixed inset-0 z-[1100] flex min-h-[100dvh] flex-col overflow-y-auto bg-slate-950 text-white">
      <div className="mx-auto flex min-h-[100dvh] w-full max-w-2xl flex-col px-5 pb-[calc(1.25rem+env(safe-area-inset-bottom))] pt-[calc(1.25rem+env(safe-area-inset-top))] sm:px-8">
