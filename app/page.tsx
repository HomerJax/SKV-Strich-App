      ...
      <section className="mx-auto w-full max-w-5xl px-4 pb-14 pt-10 text-center sm:px-6 lg:px-8 lg:pt-16">
        <div className="flex flex-col items-center">
          ...
          <Image
            ...
            priority
          />
          <div className="mt-4 text-[2.2rem] font-black tracking-[-0.04em]">
            strikr
          </div>
          ...
          <p className="mt-5 max-w-2xl text-base font-medium leading-7 text-zinc-600 sm:text-lg">
            Zusagen. Faire Teams. Spielen. Ergebnis eintragen. strikr macht
            daraus automatisch eine laufende Tabelle, persönliche Statistiken,
            Spieler-Vergleiche und Trophäen.
          </p>
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-black px-7 py-4 text-sm font-black text-white transition hover:bg-zinc-800"
            >
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-2xl border border-black/20 px-7 py-4 text-sm font-bold hover:bg-zinc-100"
            >
              Login
            </Link>
          </div>
          ...
          <div className="mt-7 w-full max-w-xl rounded-[28px] border border-black/10 bg-zinc-50 p-4 sm:p-5">
            <div className="mb-3 text-xs font-black uppercase tracking-[0.16em] text-zinc-500">
              strikr aufs Smartphone
            </div>
            <StoreButtons />
          </div>
          <p className="mt-4 text-xs font-semibold text-zinc-500">
            Aktuell komplett kostenlos und ohne Verpflichtung.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 text-3xl font-black sm:text-4xl">
              Vom normalen Training zur eigenen Saison.
            </h2>
            <p className="mt-4 text-sm leading-6 text-white/70 sm:text-base">
              Keine komplizierte Vereinsverwaltung. strikr konzentriert sich auf
      ...
      <section className="border-t border-black/10 bg-white">
        <div className="mx-auto max-w-5xl px-4 py-12 text-center sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl rounded-[32px] border border-black bg-black p-6 text-white shadow-xl sm:p-9">
            <div className="inline-flex rounded-full border border-emerald-300/30 bg-emerald-300/10 px-3 py-1 text-xs font-black text-emerald-100">
              EARLY TEAM / FOUNDER
            </div>
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-white/70">
              strikr ist aktuell komplett kostenlos. Teams, die jetzt früh mit
              uns starten und Feedback geben, sichern sich Founder-Status und
              dauerhafte Vorteile, falls später ein Premium-Modell dazukommt.
            </p>
            <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:justify-center">
              <Link
                href="/signup?next=%2Fclub-setup"
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-6 py-3.5 text-sm font-black text-black hover:bg-zinc-100"
              >
                Founder-Team werden <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
            <p className="mt-4 text-xs font-semibold text-white/45">
              Keine Paywall. Keine Verpflichtung. Spätere Änderungen werden
      ...
      <section className="border-t border-black/10 bg-zinc-50">
        <div className="mx-auto max-w-5xl px-4 py-12 text-center sm:px-6 lg:px-8">
          <h2 className="text-3xl font-black sm:text-4xl">
            Bereit fürs nächste Training?
          </h2>
          <p className="mt-3 text-sm font-medium text-zinc-600">
            Team anlegen, Spieler einladen und beim nächsten Training einfach
            ausprobieren.
          </p>
          <div className="mt-7">
            <StoreButtons />
          ...
          <div className="mt-6">
            <Link
              href="/signup?next=%2Fclub-setup"
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-black px-7 py-4 text-sm font-black text-white hover:bg-zinc-800"
            >
              Team kostenlos starten <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
