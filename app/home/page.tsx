    ...
    <main className="min-h-screen bg-neutral-100 pb-24">
      ...
      <section className="mx-auto flex w-full max-w-5xl flex-col gap-3 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <a
          ...
          className="group flex items-center justify-between gap-4 overflow-hidden rounded-[24px] border border-fuchsia-200 bg-gradient-to-r from-fuchsia-50 via-pink-50 to-orange-50 p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
        >
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-fuchsia-600 via-pink-500 to-orange-400 text-white shadow-sm">
              <Instagram className="h-5 w-5" />
            </div>
            <div className="min-w-0">
              <div className="text-[11px] font-black uppercase tracking-[0.16em] text-fuchsia-700">
                strikr auf Instagram
              </div>
              <div className="mt-0.5 truncate text-base font-black text-slate-950">
                Folge @getstrikr
              </div>
              <div className="mt-0.5 text-xs font-semibold text-slate-500">
                News, Updates & Trainingscontent
              </div>
            </div>
          </div>

          <div className="shrink-0 rounded-full bg-slate-950 px-3 py-2 text-xs font-black text-white transition group-hover:bg-fuchsia-700">
            Folgen →
          </div>
        </a>
      </section>
